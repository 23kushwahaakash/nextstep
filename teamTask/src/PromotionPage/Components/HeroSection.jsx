        ...
        <div className="absolute top-15 md:top-50 flex flex-col justify-center items-center w-full ">
            <div className="flex flex-col w-full md:w-[60%] justify-center items-center">
                ...
                <div className="flex mt-2 md:mt-30 gap-5">
                   <button className="text-white bg-[#1c58c1] md:text-4xl px-5 md:px-10 md:py-2 py-1 rounded-md">Log In</button>
                   <button className="text-white bg-[#1c58c1] md:text-4xl px-5 md:px-10 md:py-2 py-1 rounded-md">Sign Up</button>
                </div>
            </div>
        </div>
    </div>
